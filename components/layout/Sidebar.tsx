...
export default function Sidebar({ overdueCount = 0 }: SidebarProps) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[280px] h-screen sticky top-0 bg-surface-container-lowest border-r border-border-luminous z-50">
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 pt-5 pb-4">
        ...
        <div>
          <h1 className="text-headline-sm text-primary leading-tight">PT Manager</h1>
      ...
      <div className="px-4 mb-4">
        <Link href="/alunos/novo">
          <button className="w-full bg-primary text-on-primary font-semibold text-label-caps py-2 rounded-lg flex items-center justify-center gap-2 transition-all duration-150 active:scale-95 tactile-btn hover:shadow-[0_0_15px_rgba(173,198,255,0.3)]">
      ...
      {/* Footer */}
      <div className="mt-auto border-t border-border-luminous pt-3 px-3 pb-4 space-y-0.5">
        <Link
          href="/login"
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-label-caps text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all duration-150"
        >
